...
if __name__ == "__main__":
    ...
    output_image = Car_detection_single_photo(input_photo ='photos/img.jpg')
...
####   Detect Cars on a video and save ######
    Car_detection_video(input_video_name='photos/video.mp4', output_video_name ='photos/delete.avi', frames_to_save = 200000)
